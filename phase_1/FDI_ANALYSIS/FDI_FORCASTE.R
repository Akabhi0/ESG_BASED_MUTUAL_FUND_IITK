...
FDI_ts <- ts(dataExcel$`FDI ( Billions of US $)`,start=c(2000),frequency=1)
...
Acf(FDI_ts_d1) #choosing 1

#BASIC ARIMA - does not work that good
tsMod <- Arima(y = FDI_ts,order = c(1,2,1))
